// Small inline icon set for the footer links. GithubIcon/LinkedinIcon SVG
// paths are copied verbatim from the portfolio site's own BrandIcons.tsx (a
// workaround there for lucide-react having dropped brand/logo icons) so the
// sites render identical marks; MailIcon/GlobeIcon are hand-drawn to the same
// sizing/stroke convention rather than pulling in lucide-react as a new
// dependency for four icons in an otherwise dependency-light app.
interface IconProps {
  size?: number;
}
